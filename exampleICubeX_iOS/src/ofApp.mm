...
void ofApp::setup(){
    ...
    //mainSettingsPanel->setFont("GUI/faucet.ttf");
    //miscSettingsPanel->setFont("GUI/faucet.ttf");
    //mappingPanel->setFont("GUI/faucet.ttf");
    
    //iOS specific: make it landscape!
...
void ofApp::setupMiscPanel() {
    ...
    miscSettingsPanel->addWidgetDown((ofxUIWidget*)sampleIntervalSlider);
...
void ofApp::setupSensorPanels() {
    ...
    for (int i=0; i<kNUM_ICUBEX_SENSORS; i++) {
        ...
        sensorPanels[i]->addWidgetDown((ofxUIWidget*)sensorValueSliders[i])->setTriggerType(OFX_UI_TRIGGER_END);
...
//***************************************************************************
//*** iOS Specific functions here. Route them to desktop UI events above...
//***************************************************************************
